...
export class FormDataService {
  ...
  getPersonal(): Personal {
    ...
    var personal: Personal = {
      ...
      driverGrade : this.formData.driverGrade
    };
    return personal;
  }
  ...
  getStepFlow(){
    return this.formData.stepFlow;
  }
  setStepFlow(flow){
    this.formData.stepFlow = flow;
  }

  getSocket() {
    return this.formData.socket;
  }

  setSocket(socket) {
    this.formData.socket = socket;
  }
  ...
  setSocketId(id:any){
    this.formData.socketId = id;
  }

  getSocketId(){
    return this.formData.socketId;
  }
